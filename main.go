...
// attack возвращает строку с описанием атаки в зависимости от класса персонажа.
...
// defence возвращает строку с описанием блокирования урона в зависимости от класса персонажа.
...
// special возвращает строку с описанием специального умения в зависимости от класса персонажа.
...
// startTraining запускает тренировку персонажа.
...
// choiceCharClass позволяет игроку выбрать класс персонажа.
